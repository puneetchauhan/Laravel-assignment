...
<div class="panel panel-primary">
 ...
 <button id="btn_add" name="btn_add" class="btn btn-default pull-right"><a href="{{ route('skill-create') }}" class="btn btn-xs btn-info pull-right">Add New Skill</a></button>
    </div>
         ...
         <tbody id="routedetails-list" name="routedetails-list">
           @foreach ($employeedetails as $employeedetail)
            <tr id="routedetail{{$employeedetail->id}}">
             <td>{{$employeedetail->skill_name}}</td>

                <td>{{$employeedetail->proficiency}}</td>
                
              <td>
			 <a href="{{ route('home') }}" class="btn btn-xs btn-info pull-right">Edit</a>
              </td>
            </tr>
            @endforeach
        </tbody>
